...
const projects = [
  {
    id: 1,
    title: 'ResumeIQ',
    description: 'A full-stack AI-powered platform that analyzes uploaded resumes using Google Gemini API and provides actionable feedback to improve content, structure, and relevance.',
    image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=500&h=300&fit=crop',
    technologies: ['TypeScript', 'Node.js', 'Express js', 'Gemini Api'],
    liveUrl: 'https://resumeiq-ats.vercel.app/',
    githubUrl: 'https://github.com/surendra-vasamsetti/resumeIQ',
    status: 'Live',
  },
  {
    id: 2,
    title: 'BLOODROP',
    description: 'A 3-tier architecture web application (User, Blood Bank, APSACS) using the MERN stack, designed to streamline the process of finding blood donors and locating available blood units.',
    image: 'https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=500&h=300&fit=crop',
    technologies: ['React js', 'Node.js', 'Express js', 'MongoDB'],
    liveUrl: 'https://final-bloodrop.vercel.app/',
    githubUrl: 'https://github.com/surendra-vasamsetti/mern-blood-auth',
    status: 'Live',
  },
  {
    id: 3,
    title: 'DevOpsifiedEnd-to-End Deployment for Multi-Microservice Application',
    description: 'Gained practical experience implementing CI/CD pipelines using GitHub Actions for a multi-microservice application, deploying Docker-containerized services to AWS EKS (Kubernetes).',
    image: 'https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=500&h=300&fit=crop',
    technologies: ['Docker', 'Kubernetes', 'AWS', 'Jenkins'],
    // liveUrl: 'https://example.com',
    githubUrl: 'https://github.com/surendra-vasamsetti/ultimate-devops-project-demo',
    status: 'Deployed',
  },
  // {
  //   id: 4,
